...
const contactInfo = [
  ...
  },
  {
    icon: (
      <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
        <path strokeLinecap="round" strokeLinejoin="round" d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 01.001 1.18 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />
      </svg>
    ),
    label: 'Phone',
  ...
  },
  {
    ...
    label: 'Email',
    value: 'hello@mixiekadai.lk', // TODO: Replace with real email
  },
  {
    icon: (
      <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
    ...
    label: 'Hours',
    value: 'Mon–Sat 9am–7pm · Sunday 10am–4pm', // TODO: Confirm opening hours
  },
]
...
export default function ContactPage() {
  ...
  function handleSubmit(e) {
    ...
    const text = encodeURIComponent(
      `Hi Mixie Kadai! My name is ${name} (${phone}).\n\n${message}`
    )
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="How can we help you? Ask about a product, spare part, delivery, or anything else."
          ...
          <div className="lg:col-span-2">
            <div className="bg-brand-surface rounded-xl p-8">
              ...
              <div className="flex flex-col gap-6">
                {contactInfo.map(({ icon, label, value }) => (
                  <div key={label} className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-body text-xs font-semibold text-brand-muted uppercase tracking-wider mb-0.5">
                        {label}
                      </p>
              ...
              <div className="mt-8 pt-6 border-t border-brand-navy/10">
                <p className="font-body text-xs font-semibold tracking-widest uppercase text-brand-muted mb-4">
                  Follow Us
                </p>
                <div className="flex items-center gap-4">
                  <a
                    ...
                    className="text-brand-navy/50 hover:text-brand-gold transition-colors duration-200"
                  >
